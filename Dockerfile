FROM --platform=linux/amd64 golang:1.27.1-bookworm AS base
...
ARG PROTOBUF_GO_VERSION=1.36.12
...
ARG PROTOBUF_PROTOPLUGIN_VERSION=2.15.0
...
ARG PROTOBUF_ES_VERSION=2.15.0
RUN npm i -g \
